...
//                {"data": "total_iva"},
    ...
    formatRowHtml: function (d) {
        ...
        html += '<tr><th scope="col">No_requision</th>';
        ...
        html += '</thead>';
        html += '<tbody>';
        $.each(d.entradainsumo, function (key, value) {
            html += '<tr>'
...
$(function () {
    ...
    $('#data tbody')
        ...
        .on('click', 'a[rel="details"]', function () {
            var tr = tblEntrada.cell($(this).closest('td, li')).index();
            var data = tblEntrada.row(tr.row).data();
