            ...
            columnDefs: [
              {
                    ...
                    render: function (data, type, row) {
                        return '<input type="text" name="cant" class="form-control form-control-sm input-sm" autocomplete="off" value="' + row.no_requiscion + '">';
                    }
                },
                {
                    targets: [-4],
        ...
        ajax: {
            ...
            data: function (params) {
                return {
                    ...
                    ids: JSON.stringify(entrada.getProductsIds())
                };
            },
            processResults: function (data) {
                return {
